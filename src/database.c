...
database_new (const char *database_kind) 
{
  ...
  database_set_kind(database, database_set_kind);
...
/* Interface setters */
void
database_callback_set_user_credentials (database_t *database,
...
void
database_callback_set_connect (database_t *database,
...
void
database_callback_set_disconnect (database_t *database,
...
void
database_callback_set_connected (database_t *database,
...
void
database_callback_set_reconnect (database_t *database,
